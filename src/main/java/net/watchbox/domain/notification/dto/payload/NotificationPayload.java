...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = ContentBoxAddedPayload.class, name = "BOX_CONTENT_ADDED")
})
public sealed interface NotificationPayload
        permits BoxInvitationPayload, BoxInvitationRespondedPayload, ContentBoxAddedPayload {
