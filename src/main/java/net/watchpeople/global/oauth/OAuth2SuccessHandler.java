package net.watchpeople.global.oauth;
...
import net.watchpeople.domain.member.entity.MemberRefreshToken;
...
import net.watchpeople.global.util.CookieUtil;
...
//    private final BoxRepository boxRepository;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        // 신규 가입자면 Member와 MyBox 생성
        Optional<Member> optionalMember = memberRepository.findByOauthAccount(oauthAccount);
        Member member;
